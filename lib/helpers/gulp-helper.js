...
module.exports = {
  ...
  getGlobalOptions: function() {
    return {
      ...
      "--storage": "The type of storage for tracking executed tasks." +
        clc.blueBright(" Default: sequelize"),
      "--storage-path": "The path to a JSON file to track executed tasks." +
        clc.blueBright(" Default: sequelize-meta.json")
    };
  },
